...
class VirusSimulationReport:
            ...
            self.propagation_log.append(
                {
                    ...
                    "percent_infected": len(self.infected_nodes)
                    / self.total_nodes
                    * 100,
                }
            )
    ...
    def generate_pdf_report(self, filename="virus_propagation_report.pdf"):
        ...
        pdf.cell(
            200,
            10,
            txt=f"Pasos Totales de Infección: {self.step_count}",
            ln=True,
            align="L",
        )
        ...
        pdf.cell(
            200,
            10,
            f"Tasa Promedio de Probabilidad de Contagio: {avg_probability:.2f}",
            ln=True,
            align="L",
        )
        ...
        pdf.cell(
            200,
            10,
            f"Número de Nodos en el Grafo Cargado: {self.total_nodes}",
            ln=True,
            align="L",
        )
    ...
    def add_graph_image(self, pdf, node, output_folder):
        ...
        if os.path.exists(filepath):
            ...
            pdf.cell(
                200,
                10,
                txt=f"Subgrafo del Nodo Más Importante (Nodo {node})",
                ln=True,
                align="C",
            )
            pdf.image(
                filepath, x=10, y=30, w=190
            )  # Ajustar la imagen para ocupar la página
        else:
    ...
    def generate_report(self):
        ...
        dpg.configure_item(
            ...
            description="El reporte PDF se ha guardado correctamente.",
        )
